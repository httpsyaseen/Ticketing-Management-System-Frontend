              ...
              <Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-2xl shadow-2xl p-6 w-full max-w-3xl max-h-[90vh] overflow-y-auto">
                <div className="flex justify-between items-center mb-6">
                  <div>
                    <Dialog.Title className="text-2xl font-bold text-gray-800">
                      {openDialog === "edit" ? "Edit User Profile" : "Create New User"}
                    </Dialog.Title>
                ...
                <div className="grid grid-cols-1 gap-6">
                  ...
                  <div className="bg-gray-50 p-5 rounded-xl border border-gray-200">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      ...
                      <div>
                        <label className="block text-sm font-medium mb-2 text-gray-700" htmlFor="userEmail">
                          Email Address
                        </label>
                        <div className="relative">
                          <input
                      ...
                      <div className="md:col-span-2">
                        <label className="block text-sm font-medium mb-2 text-gray-700" htmlFor="userPassword">
                          Password
                          {openDialog === "edit" && (
                            <span className="text-xs text-gray-500 ml-2 font-normal">(leave blank to keep current)</span>
                          )}
                        </label>
                        <div className="relative">
                          <input
                ...
                <div className="flex justify-end gap-3 mt-8 pt-6 border-t border-gray-200">
                  ...
                  <button 
                    ...
                    onClick={openDialog === "edit" ? handleUpdateUser : handleCreateUser}
                  >
                    {formSubmitting ? (
              ...
              <div className="px-6 pb-6">
                      ...
                      <AnimatePresence>
                        {users?.map((user) => (
                          ...
                          >
                            ...
                            <td className="px-6 py-4">
                              <div className="text-sm text-gray-900">{user.assignedTo?.name}</div>
                              <div className="text-sm text-gray-500 capitalize">{user.assignedToType.toLowerCase()}</div>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap">
                              <span className={`px-2.5 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${
                                user.active 
                ...
                {users.length === 0 && (
                  <div className="text-center py-12 text-gray-500 bg-gray-50 rounded-xl">
                    ...
                    <h3 className="mt-4 font-medium text-gray-900">No users found</h3>
